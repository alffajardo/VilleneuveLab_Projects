#!/bin/bash
#Description: a wrapper for qc_spm12.R 
...
# Run the script
Rscript qc_spm12.R $subject_dir 
...
echo "# SPM12: ${dir} Spatial Normalization" > ${dir}.md 
...
# masks
echo "## CenTaur Masks in  Anat" >> ${dir}.md
 echo "

" >> ${dir}.md
echo -e "![](files/${dir}_ROIS.png)" >> ${dir}.md
