...
#lID <- "sub-PADMTL0002_TAU_ses-01"

roi_string <- "vlpp.nii.gz"
pet_string <- "_pet_time-4070_space-tpl.nii.gz"
ref<- "voi_CerebGry_tau_1mm_vlpp.nii"
...
# PET NAME 
pet_name <- list.files(pattern = pet_string)
...
print(tibble(subject_data))

output <- paste(ID,"_Centaur_spm8.csv",sep = "")
print(output)
# write the file 
